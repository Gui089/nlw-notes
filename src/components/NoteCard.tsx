...
const NoteCard = (props: NotecardProps) => {
    return (
        <Dialog.Root>
            <Dialog.Trigger className='outline-none rounded-md text-left flex-col bg-slate-800 p-5 gap-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>
